...
export default function SchemaCard({ name, version }) {
  return (
    <>
      <div className="rounded-lg px-6 py-4 text-sm bg-[#EDEDED] text-[#0F163A] relative overflow-hidden w-full border-2 hover:border-[#0F163A] duration-200 ease-in-out cursor-pointer">
        <div className="py-2">
          <svg
            width="314"
            height="214"
          ...
          <div className="flex">
            <div className="">
              <div className="flex flex-col">
                <div className="text-2xl flex flex-col">{name}</div>
              </div>
              <div className="flex flex-col">
                <div className="mt-1 flex flex-col">Version: {version}</div>
              </div>
            </div>
          </div>
        </div>
