...
export default function UserCard({ username, email, roles }) {
  return (
      ...
      <div className="py-2">
        ...
        <div className="mt-4 grid grid-cols-2 gap-4">
          <div className="flex flex-col">
            <div className="mt-1 flex flex-col">{username}</div>
          </div>
          <div className="flex flex-col">
            <div className="mt-1 flex flex-col">{email}</div>
          </div>
          <div className="flex flex-col">
            <div className="mt-1 flex flex-col">{roles}</div>
          </div>
        </div>
      </div>
    </div>
